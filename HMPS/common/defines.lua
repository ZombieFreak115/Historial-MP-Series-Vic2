...
military = {
	...
	NAVAL_COMBAT_DAMAGE_ORG_MULT = 0.3, -- scale the damage to ORG for balancing gameplay
...
diplomacy = {
	...
	BREAKTRUCE_PRESTIGE_ADD_TO_SPHERE = -100,
	BREAKTRUCE_PRESTIGE_RELEASE_PUPPET = -100,
	BREAKTRUCE_PRESTIGE_MAKE_PUPPET = -100,
	BREAKTRUCE_PRESTIGE_DISARMAMENT = -100,
	BREAKTRUCE_PRESTIGE_DESTROY_FORTS = -100,
	BREAKTRUCE_PRESTIGE_DESTROY_NAVAL_BASES = -100,
	BREAKTRUCE_PRESTIGE_REPARATIONS = -100,
	BREAKTRUCE_PRESTIGE_TRANSFER_PROVINCES = -100,
	BREAKTRUCE_PRESTIGE_REMOVE_CORES = 0,
	BREAKTRUCE_PRESTIGE_PRESTIGE = -100,
	BREAKTRUCE_PRESTIGE_CONCEDE = -100,
	BREAKTRUCE_PRESTIGE_STATUS_QUO = -100,
	BREAKTRUCE_PRESTIGE_ANNEX = -100,
	BREAKTRUCE_PRESTIGE_DEMAND_STATE = -100,
	BREAKTRUCE_PRESTIGE_INSTALL_COMMUNIST_GOV_TYPE = -100,
	BREAKTRUCE_PRESTIGE_UNINSTALL_COMMUNIST_GOV_TYPE = -100,
	BREAKTRUCE_PRESTIGE_COLONY = -100,
